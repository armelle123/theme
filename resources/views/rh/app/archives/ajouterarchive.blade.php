                   ...
                   <div class="card-body">
                    ...
                    <div class="mt-3">
                      ...
                      <div class="alert alert-danger">
                        ...
                        @endif --}}
                          <form  style="width:65%" style="color:black"method="post" enctype ="multipart/form-data" action="{{route('fichiers.ajouter')}}" >
                            @csrf
                              ...
                              <div class="black-bold-file" style="color:black" >
